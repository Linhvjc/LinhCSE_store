"""
Convert RankCSE's checkpoints to Huggingface style.
"""
...
def main():
    ...
    parser.add_argument("--path", type=str, help="Path of RankCSE checkpoint folder")
    args = parser.parse_args()

    print("RankCSE checkpoint -> Huggingface checkpoint for {}".format(args.path))
